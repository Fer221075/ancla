...
<section>
    <img class="full-w" src="<?php echo get_template_directory_uri();?>/img/soporte-banner.jpg" alt="soporte">
</section>
...
<section>
    ...
    <div class="home-products-header">
        <div class="container">
            <h3>SOPORTE TÉCNICO
                <small>
                    <img src="<?php echo get_template_directory_uri();?>/img/mini_icono_soporte.png">
                </small>
            </h3>
        </div>
    </div>
            ...
            <div class="col-md-6">
                <div class="border-box">
                    ...
                    <div class="text-center">
                        <a href="javascript" class="btn btn-border-red">
